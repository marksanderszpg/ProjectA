...
Begin VB.Form ConfirmReserveFrm 
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Confirm Room Reserved Form"
   ClientHeight    =   6240
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9525
   ...
   Begin VB.Label Label21 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "http://webgeekresources.com"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   18
         Charset         =   0
   ...
   Begin VB.Label Label1 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Confirm Reservation Transaction"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   9.75
         Charset         =   0
   ...
   Begin VB.Image Image3 
      Height          =   645
      Left            =   0
      Picture         =   "ConfirmReserveFrm.frx":0000
      Top             =   0
      Width           =   12960
   End
End
Attribute VB_Name = "ConfirmReserveFrm"
...
Else
clsData.updateCheckOutByinReserved CurrentUser, txtrCode
clsData.updateRoomStatToOccupied txtrName, txtCustName, Text2
clsData.setInTypeToCheckIn txtrCode
...
Unload Me
ConfirmReserveFrm.Show 1, ControlPanel
End Sub
Private Sub Command1_Click()
ListOfReserveRoomToBeConfirm.Show 1
End Sub
...
MsgBox "Please select room", vbInformation, ""
Else
clsData.cancelReserverationSetToCancelled txtrCode
